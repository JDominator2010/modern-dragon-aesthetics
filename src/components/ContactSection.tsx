              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:team@dragonbrothers.edu" className="text-gray-700 hover:text-black transition-colors">
                      team@dragonbrothers.edu
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <address className="text-gray-700 not-italic">
                      Dragon High School<br />
                      Robotics Lab, Room 142<br />
